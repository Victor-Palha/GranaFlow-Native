...
export function ModalCreateTransaction({ wallet_id, isModalOpen, closeModal }: ModalCreateTransactionProps) {
    const {refetchTransactions} = useContext(TransactionContext)
